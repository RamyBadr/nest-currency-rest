...
const role_type_register_1 = require("../../../common/constants/role-type-register");
...
__decorate([
    swagger_1.ApiModelProperty({
        enum: Object.keys(role_type_register_1.RoleTypeRigester),
        default: 'User',
...
__decorate([
    typeorm_1.Column(),
    class_validator_1.IsPhoneNumber('EG'),
    class_validator_1.IsOptional(),
    swagger_1.ApiModelProperty(),
    __metadata("design:type", String)
