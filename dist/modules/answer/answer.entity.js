...
let AnswerEntity = class AnswerEntity extends abstract_entity_1.AbstractEntity {
    constructor() {
        super(...arguments);
        this.dtoClass = AnswerDto_1.AnswerDto;
    }
};
__decorate([
...
AnswerEntity = __decorate([
    ...
    typeorm_1.Index(['question', 'iscorrect'], { unique: true, where: 'iscorrect=true' }),
    typeorm_1.Index(['question', 'text'], { unique: true })
], AnswerEntity);
